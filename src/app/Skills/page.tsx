...
function page() {
  return (
    <div className=" h-[55rem] bg-[#fffff] bg-grid-black/[0.2]">
      ...
      <div className="w-full  pt-15 inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-200px),transparent_100%)] mt-10">
